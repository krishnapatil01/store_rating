  ...
  return (
    <div className="bg-primary/95 backdrop-blur-md text-white py-2 px-4 border-b border-gray-800 text-xs flex flex-wrap items-center justify-between gap-3 sticky top-0 z-50">
      <div className="flex items-center gap-2">
        <span className="flex h-2 w-2 rounded-full bg-pastel-mint animate-pulse" />
      ...
      <div className="flex items-center gap-1.5 bg-gray-900/60 p-1 rounded-xl border border-gray-700/60">
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1 rounded-lg font-medium transition-all ${
            role === 'NORMAL_USER'
              ? 'bg-pastel-lavender text-primary shadow-sm font-semibold'
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1 rounded-lg font-medium transition-all ${
            role === 'STORE_OWNER'
              ? 'bg-pastel-peach text-primary shadow-sm font-semibold'
              : 'text-gray-300 hover:text-white hover:bg-gray-800'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1 rounded-lg font-medium transition-all ${
            role === 'SYSTEM_ADMIN'
              ? 'bg-pastel-mint text-primary shadow-sm font-semibold'
              : 'text-gray-300 hover:text-white hover:bg-gray-800'
          }`}
        >
