    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-48 h-48 bg-pastel-lavender/40 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-pastel-yellow/30 rounded-full blur-3xl -ml-16 -mb-16 pointer-events-none" />
          ...
          {isSuccess ? (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-pastel-mint text-emerald-700 flex items-center justify-center mb-4 shadow-soft">
            ...
            <div>
              {/* Header */}
              <div className="mb-6">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-pastel-peach/50 text-amber-900 text-xs font-semibold mb-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-2xl border border-borderSoft bg-white p-3.5 text-sm placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-pastel-lavender focus:border-pastel-lavender transition-colors resize-none"
                  />
                </div>
