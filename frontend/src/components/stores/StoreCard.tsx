...
const ACCENT_STYLES = {
  lavender: {
    banner: 'bg-pastel-lavender/60 border-purple-100',
    badge: 'bg-purple-100/80 text-purple-900',
    initial: 'bg-purple-200/90 text-purple-900',
    button: 'bg-pastel-lavender text-primary hover:bg-pastel-lilac',
  },
  peach: {
    banner: 'bg-pastel-peach/60 border-orange-100',
    badge: 'bg-orange-100/80 text-orange-900',
    initial: 'bg-orange-200/90 text-orange-900',
    button: 'bg-pastel-peach text-primary hover:bg-amber-200',
  },
  mint: {
    banner: 'bg-pastel-mint/60 border-emerald-100',
    badge: 'bg-emerald-100/80 text-emerald-900',
    initial: 'bg-emerald-200/90 text-emerald-900',
    button: 'bg-pastel-mint text-primary hover:bg-emerald-200',
  },
  blue: {
    banner: 'bg-pastel-blue/60 border-sky-100',
    badge: 'bg-sky-100/80 text-sky-900',
    initial: 'bg-sky-200/90 text-sky-900',
    button: 'bg-pastel-blue text-primary hover:bg-sky-200',
  },
  yellow: {
    banner: 'bg-pastel-yellow/60 border-amber-100',
    badge: 'bg-amber-100/80 text-amber-900',
    initial: 'bg-amber-200/90 text-amber-900',
    button: 'bg-pastel-yellow text-primary hover:bg-yellow-200',
  },
  rose: {
    banner: 'bg-rose-100/60 border-rose-200',
    badge: 'bg-rose-100/80 text-rose-900',
    initial: 'bg-rose-200/90 text-rose-900',
    button: 'bg-rose-100 text-primary hover:bg-rose-200',
  },
};
      ...
      <div className="p-6 pt-9 flex-1 flex flex-col justify-between">
        <div>
          <div className="flex items-baseline justify-between gap-2 mb-2">
            ...
            <div className="flex items-center gap-1 bg-pastel-yellow/60 px-2 py-0.5 rounded-lg border border-amber-200/50 shrink-0">
