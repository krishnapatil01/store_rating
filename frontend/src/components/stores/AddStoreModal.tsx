    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="mb-6">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-pastel-mint/60 text-emerald-900 text-xs font-semibold mb-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-2xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-mint transition-colors ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-2xl border pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-mint transition-colors ${
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-2xl border border-borderSoft bg-white px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-mint"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full rounded-2xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-mint resize-none ${
                  ...
                  {(['lavender', 'peach', 'mint', 'blue', 'yellow', 'rose'] as const).map((col) => (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border-2 transition-transform ${
                        ...
                        col === 'lavender' ? 'bg-pastel-lavender' :
                        col === 'peach' ? 'bg-pastel-peach' :
                        col === 'mint' ? 'bg-pastel-mint' :
                        col === 'blue' ? 'bg-pastel-blue' :
                        col === 'yellow' ? 'bg-pastel-yellow' : 'bg-rose-200'
                      }`}
                    />
                  ))}
                </div>
