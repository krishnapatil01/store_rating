      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex items-start gap-5 mb-6 pb-6 border-b border-borderSoft">
            <div className="w-16 h-16 rounded-3xl bg-pastel-lavender border-2 border-brand/20 flex items-center justify-center font-heading font-bold text-2xl text-primary shrink-0 shadow-soft">
              {user.name.charAt(0)}
            </div>
          ...
          {user.role === 'STORE_OWNER' && ownedStore && (
            <div className="p-5 rounded-2xl bg-pastel-peach/30 border border-orange-100">
