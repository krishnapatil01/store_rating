    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="mb-6">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-pastel-lavender/60 text-purple-900 text-xs font-semibold mb-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  { id: 'NORMAL_USER', label: 'Normal User', accent: 'border-brand/20 bg-pastel-lavender/40 text-purple-950' },
                  { id: 'STORE_OWNER', label: 'Store Owner', accent: 'border-orange-200 bg-pastel-peach/40 text-orange-950' },
                  { id: 'SYSTEM_ADMIN', label: 'Admin', accent: 'border-emerald-200 bg-pastel-mint/40 text-emerald-950' },
                ].map((r) => (
                  <button
                    key={r.id}
                    type="button"
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-2xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-lavender transition-colors ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-2xl border pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-lavender transition-colors ${
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full rounded-2xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-lavender resize-none ${
