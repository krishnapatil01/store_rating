    ...
    <div className="min-h-screen bg-background flex flex-col selection:bg-pastel-lavender">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 flex-1 w-full">
        ...
        <div className="mb-10 max-w-3xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pastel-lavender/60 text-purple-950 text-xs font-semibold mb-3">
              <Sparkles className="w-3.5 h-3.5" />
              Community Store Explorer
            </div>
            <h1 className="text-4xl sm:text-5xl font-heading font-bold text-primary mb-3 tracking-tight">
              Find a place worth rating.
            </h1>
            <p className="text-base sm:text-lg text-muted leading-relaxed">
              Discover stores, explore community sentiment, and share your own authentic experiences.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            ...
            <div className="md:col-span-5 relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-2xl bg-gray-50/80 border border-borderSoft/80 text-sm focus:outline-none focus:ring-2 focus:ring-pastel-lavender focus:bg-white transition-all placeholder:text-muted"
              />
              {nameQuery && (
                <button
            ...
            <div className="md:col-span-3 flex items-center gap-2">
              <div className="relative w-full">
                <select
                  ...
                  className="w-full px-4 py-3 rounded-2xl bg-gray-50/80 border border-borderSoft/80 text-sm font-heading font-medium text-primary focus:outline-none focus:ring-2 focus:ring-pastel-lavender transition-all appearance-none cursor-pointer"
                >
        ...
        {filteredStores.length > 0 ? (
          ...
          >
            <div className="w-16 h-16 rounded-full bg-pastel-peach/60 text-amber-900 flex items-center justify-center mx-auto mb-4">
