...
const PIE_COLORS = ['#1f2937', '#6b7280', '#9ca3af', '#d1d5db', '#e5e7eb'];
...
export function StoreOwnerDashboardPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-background flex flex-col selection:bg-pastel-peach">
        <Navbar />
    ...
    <div className="min-h-screen bg-background flex flex-col selection:bg-pastel-peach">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 w-full flex-1 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pastel-peach/60 text-amber-900 text-xs font-semibold mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="absolute top-0 right-0 w-80 h-80 bg-pastel-yellow/30 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-60 h-60 bg-pastel-peach/30 rounded-full blur-3xl -ml-20 -mb-20 pointer-events-none" />
            ...
            <div className="relative z-10">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="p-3 bg-pastel-yellow/70 rounded-2xl text-amber-900 border border-amber-200/60 shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 relative z-10 pt-6 border-t border-borderSoft">
              <div className="bg-gray-50/80 p-4 rounded-2xl border border-borderSoft flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-pastel-mint text-emerald-800 flex items-center justify-center font-bold">
              ...
              <div className="bg-gray-50/80 p-4 rounded-2xl border border-borderSoft flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-pastel-lavender text-purple-900 flex items-center justify-center font-bold">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="p-6 rounded-3xl bg-pastel-mint/30 border border-emerald-100 shadow-soft">
            ...
            <div className="p-6 rounded-3xl bg-pastel-peach/30 border border-orange-100 shadow-soft">
            ...
            <div className="p-6 rounded-3xl bg-pastel-lavender/30 border border-purple-100 shadow-soft">
          ...
          <div className="divide-y divide-gray-100">
            {ratings.map((rate) => (
              <div key={rate.id} className="py-5 first:pt-0 last:pb-0 flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-pastel-lavender/50 text-purple-900 flex items-center justify-center font-bold shrink-0">
                  {(rate.userName || rate.user?.name || 'A').charAt(0)}
                </div>
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="font-heading font-semibold text-primary">{rate.userName || rate.user?.name || 'Anonymous User'}</h4>
