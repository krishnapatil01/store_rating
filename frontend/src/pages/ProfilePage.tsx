  ...
  return (
    <div className="min-h-screen bg-background flex flex-col selection:bg-pastel-lavender">
      ...
      <main className="max-w-4xl mx-auto px-6 py-10 w-full flex-1 space-y-8">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-pastel-lavender/60 text-purple-900 text-xs font-semibold mb-2">
        ...
        >
          <div className="flex items-center gap-4 mb-6 pb-6 border-b border-borderSoft">
            <div className="w-16 h-16 rounded-3xl bg-pastel-lavender/80 border-2 border-brand/20 flex items-center justify-center font-heading font-bold text-2xl text-primary shadow-2xs">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-2xl border text-sm focus:outline-none focus:ring-2 focus:ring-pastel-lavender ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={2}
                  className={`w-full pl-10 pr-4 py-3 rounded-2xl border text-sm focus:outline-none focus:ring-2 focus:ring-pastel-lavender resize-none ${
        ...
        >
          <div className="flex items-center gap-3 mb-6 pb-6 border-b border-borderSoft">
            <div className="w-10 h-10 rounded-2xl bg-pastel-mint text-emerald-800 flex items-center justify-center font-bold">
          ...
          <form onSubmit={handleUpdatePassword} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
                className={`w-full px-4 py-3 rounded-2xl border text-sm focus:outline-none focus:ring-2 focus:ring-pastel-mint ${
